...
namespace Negocio
{
    public class PlantaService
    {
        ...
        public string Update(string nome, string nomecientifico, string observacoes, DateTime datadeverificacao, int ciclodeagua, int cicloiluminista, string tipodesolo, int? codigo)
        {
